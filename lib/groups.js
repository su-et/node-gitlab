module.exports = function groups (apiReq) {
  ...
  api.get = function groupsGet (id, params) {
    return apiReq('/groups' + (id ? '/' + id : ''), params);
  };
  ...
  api.create = function groupsCreate (group) {
    ...
    return apiReq('/groups', { method: 'POST', body: group });
  };

  api.delete = function groupsDelete (id) {
    return apiReq('/groups/' + id, { method: 'DELETE' });
  };
...
*/  
  api.getMembers = function groupsMembers (id) {
  ...
  */
  ...
  api.deleteMember = function groupsDeleteMember (id, userId) {
    return apiReq('/groups/' + id + '/members/' + userId, { method: 'DELETE' });
  };
